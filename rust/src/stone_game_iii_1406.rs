...
pub fn stone_game_iii(stone_value: Vec<i32>) -> String {
    ...
    let (neg_dp0, ..) = stone_value.iter().rfold((0i32, None, None), |(a, b, c), &v| {
        // `a` is unconditional, so it seeds the inner fold and there is no empty-max case.
